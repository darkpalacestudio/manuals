...
cp *.md $BUILD_FOLDER/
cp $WORKSPAC_DIR/common/*.md $BUILD_FOLDER/
cp $WORKSPAC_DIR/common/style_dark.css $BUILD_FOLDER/
cp $WORKSPAC_DIR/common/style_print.css $BUILD_FOLDER/
cp -r $WORKSPAC_DIR/common/assets $BUILD_FOLDER/
tree $BUILD_FOLDER/
